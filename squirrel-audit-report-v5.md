...
<site url="https://muchotexto.net" crawled="100" date="2026-09-03T01:49:31.129Z"/>
<score overall="79" grade="C">
...
<summary passed="10838" warnings="863" failed="0"/>
<issues>
 ...
 <category name="Performance" errors="0" warnings="211">
  <rule id="perf/ttfb" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/perf/ttfb">
   ...
   Pages (2): /articulos/2026/05/15/cinco-tecnologias-que-prometieron-cambiar-todo, /articulos/2026/05/16/peter-thiel-paraguay-experimento
   Items (2):
    - /articulos/2026/05/15/cinco-tecnologias-que-prometieron-cambiar-todo (Slow server response (736ms))
    - /articulos/2026/05/16/peter-thiel-paraguay-experimento (Slow server response (731ms))
  </rule>
  <rule id="perf/dom-size" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/perf/dom-size">
   ...
   Items (5/10):
    ...
    - /articulos/2026/05/28/magnifica-humanitas-enciclica-ia (Element with 85 children found)
  </rule>
