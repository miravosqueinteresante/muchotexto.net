...
- [IA, sociedad y trabajo](#ia-sociedad-y-trabajo) — educación, talento, gobierno digital, salud
- [Tecnología aplicada y ecosistema](#tecnología-aplicada-y-ecosistema) — blockchain, fintech, startups, smart cities
- [Cultura, filosofía y futuro](#cultura-filosofía-y-futuro) — ética, identidad, prospectiva

**Observatorio:**

- [Cronología](/cronologia/) — Hitos de IA en Paraguay desde 1973
- [Mapa regulatorio](/regulacion/) — Leyes, decretos y estrategias vigentes
...
- **El modelo institucional que PSR propone para el sector eléctrico paraguayo** — El consultor brasileño PSR preparó para el MIC (con el PNUD) una propuesta de modernización con cuatro funciones separadas: política, planificación, regulación y operación. El punto de partida de los proyectos de ley presentados en la Mesa Nacional del 13 de agosto. Verificado con el documento oficial publicado en energia.paraguay.gov.py.
