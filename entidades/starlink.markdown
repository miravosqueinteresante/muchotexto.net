...
related_articles:
  ...
  - title: "Yguazú Digital y la apuesta de Paraguay por convertirse en hub de IA"
    ...
    context: "artificial/ 15 junio 2026 - MITIC — 'Paraguay recibe el primer lote de kits Starlink'https;//mitic.gov.py/paraguay-recibe-el-primer-lote-de-kits-starlink-para-ampliar-la-conectividad-nacional/ 18 juni"
  - title: "Starlink ya conecta a 20.000 paraguayos donde la fibra no llega"
    ...
    context: "la licencia de una empresa que ningún paraguayo había usado todavía. Se llamaba Starlink, pertenecía a SpaceX, y prometía llevar internet de alta velocidad a cualquier punto del país mediante una cons"
  - title: "Paraguay tiene 1.5M de identidades digitales y 480 trámites online"
    ...
    context: "os en detalle en nuestro análisis de conectividad rural{% posturl 2026-07-15-starlink-paraguay-conectividad %}. Digitalizar servicios sin incluir a quienes están fuera del sistema formal es eficiencia"
  - title: "Paraguay no usa IA para hacer periodismo pero la desinformación sí"
    url: /articulos/2026/07/16/ia-periodismo-paraguay/
    context: "nuestro artículo sobre conectividad rural en Paraguay{% posturl 2026-07-15-starlink-paraguay-conectividad %}, la brecha digital es más profunda. El periodismo impreso tiene una de las tasas de lectura"
  - title: "Paraguay tiene telemedicina desde 2013, la IA en salud todavía no"
    url: /articulos/2026/07/16/ia-salud-paraguay/
    context: "mismas donde la brecha de conectividad es más profunda{% posturl 2026-07-15-starlink-paraguay-conectividad %}. La tasa de mortalidad infantil nacional es de 13,7 por cada 1.000 nacidos vivos, pero ese"
related_glossary:
  - term: "Starlink"
    url: /artículos/2026/07/15/starlink-paraguay-conectividad/
related_observatory:
  - label: "Starlink"
    url: /artículos/2026/07/15/starlink-paraguay-conectividad/
    context: "Constelación de internet satelital de SpaceX (Elon Musk) con más de 10.000 satélites en órbita baja terrestre. Disponible en Paraguay desde diciembre "
  - label: "2023"
    url: /articulos/2026/07/15/starlink-paraguay-conectividad/
