...
<site url="https://muchotexto.net" crawled="100" date="2026-09-03T00:12:38.824Z"/>
...
<issues>
 ...
 <category name="Core SEO" errors="0" warnings="109">
  <rule id="core/meta-title" severity="error" status="warn" docs="https://docs.squirrelscan.com/rules/core/meta-title">
   ...
   Items (5/71):
    ...
    - /dashboard-energetico/ (Dashboard energético de data centers y tarifas | m (63 chars))
    - /glosario/ (Glosario vivo de Inteligencia Artificial en Paragu (69 chars))
    - /entidades/ (Entidades — Infraestructura de conocimiento sobre  (81 chars))
 ...
 <category name="Links" errors="0" warnings="6">
  <rule id="links/broken-external-links" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/links/broken-external-links">
   ...
   Items (5/28):
    - https://www.linkedin.com/in/cesar-sanchez-melgarejo/ (https://www.linkedin.com/in/cesar-sanchez-melgarejo/ (999)) [status: 999] (from: /, /calculadora-energetica, /calculadora-energetica, /about, /about; +195 more)
 ...
 <category name="Performance" errors="0" warnings="211">
  <rule id="perf/ttfb" severity="warning" status="warn" docs="https://docs.squirrelscan.com/rules/perf/ttfb">
   ...
   Pages (2): /casos-de-uso, /articulos/2026/06/27/anotacion-datos-paraguay-hub-trabajo-digital-ia
   Items (2):
    - /casos-de-uso (Slow server response (625ms))
    - /articulos/2026/06/27/anotacion-datos-paraguay-hub-trabajo-digital-ia (Slow server response (735ms))
  </rule>
