...
<site url="https://muchotexto.net" crawled="100" date="2026-09-03T01:42:44.768Z"/>
<score overall="76" grade="C">
 <cat name="Structured Data" score="49"/>
...
<summary passed="10759" warnings="861" failed="81"/>
<issues>
 ...
 <category name="Structured Data" errors="81" warnings="0">
  <rule id="schema/json-ld-valid" severity="warning" status="fail" docs="https://docs.squirrelscan.com/rules/schema/json-ld-valid">
   ...
   Pages (5/81): /about, /calculadora-energetica, /casos-de-uso, /claims-verificados, /como-trabajamos
   Items (5/7):
    - parse-0 (Validation: Article.image is required)
    - parse-1 (Validation: Article.datePublished is required)
    - parse-2 (Validation: Article.publisher.logo is required)
    - Article:image (Article missing image) [message: Validation: Article.image is required, severity: missing, path: [&quot;image&quot;]]
 ...
 <category name="Performance" errors="0" warnings="209">
