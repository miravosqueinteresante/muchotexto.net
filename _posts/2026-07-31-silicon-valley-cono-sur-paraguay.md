...
En marzo de 2026 el ministro de Industria y Comercio de Paraguay, Marco Riquelme, aterrizó en Silicon Valley con una agenda de reuniones que incluía a OpenAI, Nvidia, Crusoe y Lambda. La misión: vender a Paraguay como el próximo destino de infraestructura de inteligencia artificial. Siete meses después, la empresa que más invirtió en Paraguay no es ninguna de esas. Es una minera de Bitcoin canadiense reconvertida.
...
Paraguay produce casi el triple de la electricidad que consume. Sus 44 teravatios-hora anuales —alimentados por Itaipú, Yacyretá y Acaray— lo convierten en el mayor exportador per cápita de energía limpia del hemisferio occidental. Esa abundancia, combinada con un régimen de maquila que grava las exportaciones de servicios al 1% y una ubicación en el corazón de Sudamérica, configura una propuesta de valor que ninguna otra economía de la región iguala. Y sin embargo, el capital de Silicon Valley sigue pasando de largo.
...
Paraguay compite por precio. La tarifa de ANDE es su principal —y casi único— argumento de venta. Pero [la cadena de valor de un data center]({% post_url 2026-07-25-cadena-valor-data-center %}) revela que la energía representa aproximadamente el 40% del costo operativo de un centro de datos de IA. El 60% restante depende de hardware importado, conectividad, talento especializado y seguridad jurídica. En esos rubros, Paraguay parte de una posición más débil que sus competidores.
...
Para un data center de inteligencia artificial que importa GPUs, servidores, sistemas de refrigeración y equipos de red —donde [el hardware representa entre el 60% y el 70% de la inversión de capital]({% post_url 2026-07-25-cadena-valor-data-center %})—, la exención de aranceles e IVA sobre equipamiento importado puede representar un ahorro de entre 15% y 20% del CAPEX total. Combinado con la tarifa eléctrica más baja de la región, el paquete fiscal-paraguayo es objetivamente el más competitivo de Sudamérica para operaciones de cómputo intensivo.
...
6. [HIVE Digital Technologies — Validación NeurIPS de infraestructura de IA en Paraguay](https://www.hivedigitaltechnologies.com/news/hives-paraguay-ai-infrastructure-performance-validated-in-columbia-university-study-research-heads-to-neurips/) (junio 2026)
7. [Data Center Dynamics — Entrevista con Cully Cavness, cofundador de Crusoe](https://www.datacenterdynamics.com/en/news/crusoe-pivots-to-building-data-centers-plans-100mw-facility/) (julio 2024)
8. [AccessWire — Paraguay's Hydroelectric Surplus Is Becoming the World's Next AI and Data Center Frontier](https://www.accesswire.com/1152241/paraguays-hydroelectric-surplus-is-becoming-the-worlds-next-ai-and-data-center-frontier-and-this-infrastructure-builder-has-been-proving-it-for-years) (marzo 2026)
9. [Forbes — South America's AI Infrastructure Reality Check](https://www.forbes.com/) (enero 2026)
10. [BTG Pactual / Canal Solar — Brazil and Chile compete for leadership in data centers](https://www.canalsolar.com.br/) (septiembre 2025)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Qué empresas de Silicon Valley invierten en Paraguay?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "HIVE Digital Technologies es la única empresa tech global con inversión significativa en Paraguay: 300 MW operativos, USD 56 millones en adquisiciones y 68% de su capacidad mundial en suelo paraguayo. Crusoe AI, X8Cloud y ASUS no tienen inversiones confirmadas. No hay hiperescaladores (Google, AWS, Microsoft, Oracle) operando en el país."
      }
    },
    {
      "@type": "Question",
      "name": "¿Por qué Paraguay atrae inversión en data centers e inteligencia artificial?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Paraguay tiene la electricidad industrial más barata de Sudamérica (USD 30-45 por MWh), un superávit energético del 200% (produce 44 TWh y consume 15 TWh), energía 100% hidroeléctrica de Itaipú y un régimen de maquila que grava las exportaciones de servicios al 1% de impuesto a la renta, con exención de IVA y aranceles para importación de equipamiento."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué necesita Paraguay para que Silicon Valley invierta más?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Paraguay necesita inversión en infraestructura de transmisión eléctrica (USD 500-1.000 millones para aprovechar el superávit), programas de formación de talento tech, un marco regulatorio permanente para data centers, mejoras en conectividad internacional de fibra óptica y una estrategia de marca país como destino de inversión tecnológica."
      }
    }
  ]
}
