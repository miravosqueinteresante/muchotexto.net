...
description: "La consultora brasileña PSR propone separar el sector eléctrico de Paraguay en ministerio, ente regulador y una ANDE enfocada. Qué dice y qué omite."
---
...
1. [PSR — Quiénes somos y clientes (psr-inc.com)](https://www.psr-inc.com/pt-br/quem-somos/)
2. [PSR — Estudio de cambio climático e hidroeléctricas en Paraguay financiado por el BID](https://www.psr-inc.com/en/news/psr-presents-preliminary-results-of-study-on-the-effects-of-climate-change-on-hydroelectric-generation-in-paraguay/) (febrero 2024)
3. [PNUD Paraguay — Proyecto 01003213 "Atracción de inversiones y promoción comercial"](https://www.undp.org/es/paraguay/proyectos/implementacion-de-acciones-para-la-atraccion-de-inversiones-y-promocion-comercial-del-paraguay)
4. [BACN — Ley 966/1964, Carta Orgánica de la ANDE (texto íntegro)](https://www.bacn.gov.py/leyes-paraguayas/2417/texto)
5. [BACN — Ley 167/1993, estructura orgánica del MOPC y VMME (texto íntegro)](https://www.bacn.gov.py/leyes-paraguayas/2407/texto)
6. [Wikipedia (EN) — "Electricity sector in Paraguay" (tabla institucional)](https://en.wikipedia.org/wiki/Electricity_sector_in_Paraguay)
7. [Mesa Eléctrica Nacional — Documentos de la reunión del 13 de agosto de 2026](https://energia.paraguay.gov.py/)
8. [PSR — "Propuesta de Modernización del Sector Eléctrico Paraguayo" (documento presentado, portada: "Preparado para el MIC por PSR (Brasil), septiembre 2025")](https://drive.mitic.gov.py/s/YaoFnTFBYtfWDES)
9. [Wikipedia (ES) — Sector eléctrico de Uruguay / URSEA](https://es.wikipedia.org/wiki/Energ%C3%ADa_el%C3%A9ctrica_en_Uruguay)
10. [Wikipedia (PT) — ANEEL](https://pt.wikipedia.org/wiki/Ag%C3%AAncia_Nacional_de_Energia_El%C3%A9trica) y [ONS](https://pt.wikipedia.org/wiki/Operador_Nacional_do_Sistema_El%C3%A9trico)
11. [Wikipedia (ES) — Ministerio de Energía de Chile](https://es.wikipedia.org/wiki/Ministerio_de_Energ%C3%ADa_%28Chile%29) y [Sector eléctrico en Chile](https://es.wikipedia.org/wiki/Sector_el%C3%A9ctrico_en_Chile)
12. [S&P Global Ratings — "Latin American Electric Utility Regulatory Framework: Signs of Increased Political Interference"](https://www.spglobal.com/ratings/en/regulatory/article/250109-latin-american-electric-utility-regulatory-framework-signs-of-increased-political-interference-s13256294) (enero 2025)
13. [BID — "Revisiting Private Participation, Governance, and Electricity Sector Performance in Latin America"](https://publications.iadb.org/en/revisiting-private-participation-governance-and-electricity-sector-performance-in-latin-america)
14. [La Nación — "Ejecutivo planteará la creación del Ministerio de Energía ante la Mesa Energética Nacional"](https://www.lanacion.com.py/politica/2026/08/11/ejecutivo-planteara-la-creacion-del-ministerio-de-energia-ante-la-mesa-energética-nacional/) (11 de agosto de 2026)
15. [La Nación — "Gobierno presenta proyectos para crear Ministerio de Minas y ente regulador eléctrico"](https://www.lanacion.com.py/politica/2026/08/13/gobierno-presenta-proyectos-para-crear-ministerio-de-minas-y-ente-regulador-eléctrico/) (13 de agosto de 2026)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Qué propone el modelo institucional de PSR para el sector eléctrico paraguayo?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Separar el sector en tres piezas: un ministerio que concentre política y planificación, un ente regulador independiente que concentre reglas y arbitraje, y una ANDE enfocada en operar el sistema. El documento, preparado por la consultora brasileña PSR para el Ministerio de Industria y Comercio en septiembre de 2025, distingue cuatro funciones (planificación, política, regulación y operación) y diagnostica que hoy están mezcladas entre el VMME-MOPC y la ANDE."
      }
    },
    {
      "@type": "Question",
      "name": "¿La ANDE regula y opera al mismo tiempo?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sí. La carta orgánica de la ANDE (Ley 966 de 1964) le asigna planificar, construir y operar la generación, transmisión y distribución, y además fijar sus propias tarifas: el artículo 84 establece que las tarifas las aprueba su Consejo de Administración. Es un monopolio verticalmente integrado y regulador de facto, lo que configura la situación de 'juez y parte' que el modelo de PSR busca corregir."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué omite el documento de PSR?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Seis asuntos decisivos: cómo se fijarán las tarifas reguladas, qué pasa con el personal de la ANDE en la transición, cómo se financiará el ente regulador, qué rol tendrán las binacionales Itaipú y Yacyretá (que concentran cerca del 97% de la capacidad hidroeléctrica), y no fija plazos ni costos de la transición."
      }
    }
  ]
}
