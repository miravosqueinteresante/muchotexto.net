...
description: "Paraguay tiene telemedicina nacional desde 2013 con más de un millón de diagnósticos. La inteligencia artificial todavía no llegó a sus hospitales."
---
...
- [Ministerio de Salud Pública — Programa Nacional de Telesalud](https://www.mspbs.gov.py/portal/) (2013-2026)
...
- [PAHO — Extensión de cobertura en salud materno-infantil en el Chaco](https://www.paho.org/es/documentos) (2025)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Paraguay tiene telemedicina?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Sí. El Ministerio de Salud Pública opera un Programa Nacional de Telesalud desde 2013, con más de un millón de telediagnósticos realizados (tomografías, electrocardiogramas, electroencefalogramas) en más de 80 centros de los 18 departamentos sanitarios. En julio de 2026, el IPS lanzó su Hospital Virtual para videoconsultas de pacientes crónicos."
      }
    },
    {
      "@type": "Question",
      "name": "¿Usa Paraguay inteligencia artificial en sus hospitales?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Paraguay no tiene algoritmos de diagnóstico asistido, predicción de brotes ni optimización de turnos funcionando en hospitales públicos. El único caso documentado de machine learning en salud fue un sistema de tamizaje de COVID-19 con imágenes de tomografía durante la pandemia. La ley de historia clínica electrónica —prerrequisito para aplicar IA sobre datos clínicos— tiene media sanción en Diputados desde abril de 2025."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué podría hacer Paraguay con IA en salud sin construir infraestructura nueva?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tres cosas sobre la infraestructura de telemedicina existente: triaje automatizado de radiografías y tomografías, predicción de brotes de dengue con modelos que correlacionen datos climáticos y de casos, y detección de retinopatía diabética en atención primaria. Las tres tecnologías ya existen y están validadas. Requieren datos clínicos estructurados —que dependen de la aprobación de la ley de historia clínica electrónica— y la decisión institucional de implementarlas."
      }
    }
  ]
}
