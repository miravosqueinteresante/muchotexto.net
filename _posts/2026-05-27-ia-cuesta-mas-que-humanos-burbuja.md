...
Esto no es un caso aislado. En abril de 2026, GitHub — propiedad de Microsoft — anunció que todos los planes de Copilot pasarían a [facturación por uso](https://github.blog/news-insights/company-news/github-copilot-is-moving-to-usage-based-billing/) a partir del 1 de junio. La semana anterior, había [pausado las nuevas suscripciones](https://github.blog/news-insights/company-news/changes-to-github-copilot-individual-plans/) de Copilot Pro y Pro+ porque los costos de inferencia de los usuarios intensivos superaban el precio mensual del plan. Como lo resumió [The Register](https://www.theregister.com/2026/04/28/microsofts-github-shifts-to-metered-ai-billing/), Microsoft está cerrando el buffet de IA: ya no puede vender IA como el "Endless Shrimp" de Red Lobster.
...
El free cash flow de los hiperescaladores ya muestra la presión. Meta cayó de $26 mil millones en el primer trimestre de 2025 a $1.2 mil millones en el mismo período de 2026. Microsoft vio su margen de free cash flow reducirse del 30% al 25%. La correlación entre los precios de las acciones de los cuatro gigantes — que históricamente se movían juntos — cayó del 80% al 20%, señal de que el mercado está empezando a diferenciar entre los que pueden monetizar la IA y los que no.
