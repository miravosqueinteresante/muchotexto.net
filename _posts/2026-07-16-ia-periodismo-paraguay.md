...
Leé el análisis completo sobre tecnología aplicada en la [guía de inteligencia artificial en Paraguay](/ia-en-paraguay/).
...
- [Chequeado — Política de inteligencia artificial](https://chequeado.com/inteligencia-artificial/)
- [Aos Fatos — Escriba y Fátima](https://www.aosfatos.org/)
- [TSE Brasil — Resolución sobre deepfakes y propaganda electoral](https://www.tse.jus.br/) (febrero 2024)
- [Universidad Columbia del Paraguay — Diplomado en Periodismo de Datos](https://www.columbia.edu.py/) (2025)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Los medios paraguayos usan inteligencia artificial?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No hay registro público de que los principales medios paraguayos (ABC Color, Última Hora, La Nación, HOY, Telefuturo, NPY) utilicen herramientas de IA en sus procesos editoriales. Paraguay no tiene organizaciones de fact-checking certificadas ni periodistas formados en verificación digital a escala. El primer programa de periodismo de datos se lanzó en 2025 y graduó a 15 personas."
      }
    },
    {
      "@type": "Question",
      "name": "¿Existe una ley en Paraguay que regule la desinformación con IA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Paraguay no tiene legislación específica sobre deepfakes, contenido generado por IA ni desinformación digital. Brasil prohibió los deepfakes en campañas electorales en febrero de 2024 y la Unión Europea incorporó el etiquetado obligatorio de contenido sintético en su AI Act. Paraguay carece de cualquier marco similar."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué necesitaría Paraguay para preparar su periodismo para la era de la IA?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Tres cosas viables: una organización de fact-checking (USD 150-300K/año, como Chequeado en Argentina), un programa de formación en periodismo de datos y verificación digital para 100 periodistas (USD 100-200K en dos años), y una ley básica de etiquetado de contenido sintético. Ninguna requiere inversión millonaria ni tecnología que no exista."
      }
    }
  ]
}
