...
1. [Poder Judicial Paraguay — Expediente Judicial Electrónico](https://www.pj.gov.py/contenido/1436-tramite-judicial-electronico/1669) (2026)
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Paraguay tiene inteligencia artificial en su sistema judicial?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "No. Paraguay tiene Expediente Judicial Electrónico desde 2016 en sus 18 circunscripciones, pero ningún tribunal usa inteligencia artificial para tomar decisiones. El avance es puramente digitalización de procesos, no automatización algorítmica."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué países de América Latina ya usan IA en sus tribunales?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Argentina tiene Prometea desde 2017 (Fiscalía de CABA, predictivo y redacción automatizada), Colombia tiene PretorIA (Corte Constitucional, identificación de patrones en tutelas), y Brasil tiene VICTOR desde 2018 (Supremo Tribunal Federal, agrupación temática de recursos)."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué es COMPAS y qué problema de sesgo algorítmico reveló?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "COMPAS es un algoritmo de evaluación de riesgo de reincidencia creado en 1998 y usado en cortes de Estados Unidos. En 2016, ProPublica reveló que etiquetaba falsamente como alto riesgo al 44.9% de acusados negros frente al 23.5% de blancos, y que los acusados negros tenían un 77% más de probabilidad de ser catalogados como violentos aún controlando por historial criminal. Su precisión general era del 61%."
      }
    }
  ]
}
