---
layout: post
title: "De la soja al silicio: el plan de Paraguay para cambiar su matriz exportadora"
date: 2026-07-01
...
Paraguay no empieza de cero. Los datos del Banco Central muestran que los servicios digitales crecieron un 97.2% interanual, alcanzando 329.9 millones de dólares —una cifra impulsada en parte por [el nuevo sector de anotación de datos para IA]({% post_url 2026-06-27-anotacion-datos-paraguay-hub-trabajo-digital-ia %}) que empieza a tomar forma en el país—. Es el rubro de servicios con mayor crecimiento relativo, muy por encima del turismo (+61.5%) o los transportes (+2.3%). Todavía representa apenas el 2.1% del total de exportaciones de bienes, pero duplicarse en un año no es un dato que se pueda ignorar.
