...
> - El ICDF Taiwánés es una agencia de cooperación al desarrollo, no un inversor con retorno comercial. El modelo financiero de Yguazú Digital para las fases II y III —donde se necesitan entre USD 5.000 y 40.000 millones— no está definido.
...
El memorando de entendimiento firmado en Taipei establece que Yguazú Digital será una entidad con participación paritaria entre Paraguay y Taiwán. Las agencias ejecutoras son el Ministerio de Tecnologías de la Información y Comunicación (MITIC) del lado paraguayo y el Fondo de Cooperación y Desarrollo Internacional (ICDF) del lado Taiwánés.
...
<script type="application/ld+json">
{
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "¿Cómo funciona el modelo de entidad binacional de Itaipú?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Itaipú es una entidad binacional creada por el Tratado de 1973 entre Paraguay y Brasil. Tiene personería jurídica internacional, capital dividido 50/50 y un Consejo de Administración con 6 miembros por país. La energía se reparte en mitades iguales. Brasil garantizó la deuda de construcción (USD 19.600 millones) a través de Eletrobras y el Tesoro brasileño. Paraguay pagó su parte en electricidad durante décadas. La deuda total se canceló el 28 de febrero de 2023."
      }
    },
    {
      "@type": "Question",
      "name": "¿Puede Paraguay replicar el modelo Itaipú con Taiwán para inteligencia artificial?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "El MoU de Yguazú Digital (mayo 2026) propone una entidad binacional 50/50 inspirada en Itaipú, pero con diferencias fundamentales: Taiwán no comparte frontera con Paraguay, el ICDF Taiwánés es una agencia de cooperación (no un inversor comercial como Eletrobras), el MoU es no vinculante, y no existe un marco legal para gobernar datos e IA en una entidad binacional. El modelo puede adaptarse pero requiere resolver financiamiento, gobernanza de datos y un cliente ancla."
      }
    },
    {
      "@type": "Question",
      "name": "¿Qué lecciones deja Yacyretá para la gobernanza de infraestructura binacional?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Yacyretá (Paraguay-Argentina, 1973) costó USD 11.500 millones —ocho veces más que el presupuesto original— y tardó casi 30 años en completarse. Las disputas sobre la cota del embalse mantuvieron la represa operando al 60% de su capacidad por dos décadas. La lección: sin un socio con incentivos económicos reales, sin un comprador garantizado y sin mecanismos vinculantes de resolución de disputas, el modelo binacional puede convertirse en una trampa institucional de largo plazo."
      }
    }
  ]
}
