...
| **Pulso Tech Paraguay** | Reporte diario de noticias de IA, tecnología, infraestructura digital y energía en Paraguay | Lun-Sáb 08:00 | Automático (gemini-3.1-flash-lite, Google Gemini API, 7 feeds RSS con filtro temático) |
| **Editorial** | Opinión diaria basada en el Pulso Tech, con análisis de temas de IA e infraestructura digital, voseo profesional, auto-linking a artículos relacionados | Lun-Sáb 18:00 | Automático (gemini-3.1-flash-lite, Google Gemini API, temperature 0.3) |
...
| Métrica | Valor |
|---|---|
| Artículos long-form publicados | 42 (39 en el observatorio) |
| Editoriales | 46 |
| Pulso Paraguay | 68 |
| **Total posts** | **156** |
...
3. **Incluir fuentes primarias paraguayas en el research_plan.md**: Wikipedia en español, ANDE, BACN, MADES, ABC Color, La Nación, Itaipú Binacional como fuentes obligatorias para cualquier subtema sobre Paraguay.
4. Cada subagente guarda hallazgos en `research_[tema]/findings_*.md`
5. Leer todos los findings y sintetizar antes de escribir una sola palabra
6. **Verificar datos paraguayos contra AGENTS.md**: consultar la sección de Claims verificados antes de aceptar cualquier cifra de Wikipedia en inglés sobre Paraguay.
...
6. **Verificación contra fuentes primarias paraguayas**: para cualquier dato sobre Paraguay, el fact-checker debe consultar Wikipedia en español, ANDE, BACN, MADES, ABC Color, La Nación e Itaipú Binacional. No depender exclusivamente de Wikipedia en inglés.
7. **Verificación contra AGENTS.md**: el fact-checker debe cruzar los claims contra la base de datos de claims verificados en AGENTS.md antes de aceptar cualquier cifra.
...
### 12.1 Pulso Tech Paraguay (cron 08:00 PYT / 12:00 UTC)

- **Script:** `scripts/pulso_diario.py`
- **Modelo:** gemini-3.1-flash-lite (Google Gemini API, tier gratuito v1beta)
- **Fuentes RSS:** 7 fuentes (ABC Tecnología, ABC Ciencia, ABC Nacionales, La Nación, NPY, Diario HOY, La Tribuna)
- **Filtro temático:** solo noticias de IA, tecnología, infraestructura digital, energía para data centers, regulación tech, startups, ciencia aplicada y economía digital. Si hay menos de 3 noticias que pasan el filtro, se genera "Sin novedades de IA/tech suficientes".
- **Formato:** Pulso Tech Paraguay con secciones condicionales (🌐 Infraestructura Digital, ⚡ Energía y Data Centers, 🤖 IA, 📋 Regulación Tech, 🚀 Innovación, 🔬 Ciencia Aplicada). Solo categorías con contenido.
...
- **Modelo:** gemini-3.1-flash-lite (Google Gemini API, tier gratuito v1beta), temperature 0.3, 3 retries con backoff
- **Dependencia:** Lee el Pulso Tech del día; si no existe, sale sin error (`sys.exit(0)`)
- **Categoría:** `editorial`
- **Pipeline:** Leer Pulso Tech → llamar API (3 retries, backoff 2s/4s/8s) → validar contenido → insertar links → guardar
- **Tono:** español profesional, sin jerga coloquial ni voseo informal
- **Foco:** exclusivamente temas de IA, tecnología e infraestructura digital en Paraguay
- **Commit:** `git add _posts/` → `git pull --rebase origin main` → `git push`
...
**Modelos IA:**
- gemini-3.1-flash-lite (pulso + editorial) — Google Gemini API (tier gratuito, v1beta)
...
| 104 | Artículo #15: "Lo que Itaipú le enseña a Paraguay sobre inteligencia artificial". Gobernanza binacional, Yguazú Digital vs Itaipú, Yacyretá, CERN, cables submarinos. 6 H2s, FAQ, 2.497 palabras, 13 fuentes. 5 subagentes investigación, 2 rondas fact-check. | 1-ago |
| 105 | Migración GitHub Models → Gemini API completada. Modelo: gemini-3-flash-preview (v1beta). Pulso y Editorial restaurados. Timezone UTC-4→UTC-3 corregido. | 1-ago |
| 106 | Hardening del sistema: validate_publish.py convierte 5 warnings de observatorio en errores bloqueantes. CI (jekyll.yml) agrega gate que cancela deploy si falta alguna página del observatorio. | 1-ago |
| 107 | Observatorio actualizado post #15: cronologia, regulacion (+Gobernanza binacional), directorio (+ICDF), casos-de-uso (+Yguazú gobernanza), glosario (+Entidad binacional), entidades regeneradas. | 1-ago |
| 108 | Pulso Tech Paraguay: migración completa de Pulso Diario Paraguay a enfoque exclusivo IA/tech/energía. Filtro temático estricto, secciones condicionales, fuentes reducidas a 7 (eliminados deportes/espectáculos/rotos). Fallback para días sin noticias. | 3-ago |
| 109 | Modelo Gemini actualizado: gemini-3-flash-preview → gemini-3.1-flash-lite (3-flash-preview saturado 503). Retry con backoff agregado a pulso (3 intentos, 2s/4s/8s). | 3-ago |
| 110 | Tono editorial profesionalizado: eliminado voseo coloquial ("che", "atende", "te toca el bolsillo"). Pulso y Editorial ahora en español paraguayo profesional. | 3-ago |
| 111 | Documentación actualizada: /como-trabajamos/ refleja nuevo enfoque Pulso Tech, fuentes, modelo y metodología. Estrategia SEO local actualizada. | 3-ago |
| 112 | Artículo #7: "Paraguay tiene energía 100% renovable y el cambio climático la amenaza". Matriz eléctrica, deforestación, sequía Itaipú, diversificación cero. 5 H2s, FAQ, 2.058 palabras, 12 fuentes. | 3-ago |
| 113 | Artículo #8: "Qué le pasa a una ciudad paraguaya cuando llega un data center". HIVE en Yguazú/Valenzuela, empleo, infraestructura privada, lecciones de Virginia/Irlanda/Suecia, vacío regulatorio PY. 5 H2s, FAQ, 2.457 palabras, 13 fuentes. Pilar 1 completado al 100%. | 4-ago |
| 114 | AGENTS.md ampliado: +sección Data centers e impacto local (9 claims verificados) + fuentes primarias paraguayas obligatorias para fact-checking. | 4-ago |
| 115 | Fact-checking reforzado: §5.8 y §6.2 de la estrategia ahora exigen fuentes PY (Wikipedia ES, ANDE, BACN, MADES, ABC Color, La Nación, Itaipú) + verificación contra AGENTS.md antes de aceptar cualquier cifra. | 4-ago |
| 116 | Artículo #42: "Paraguay 2040: un país construido con datos". Prospectiva a 15 años: bono demográfico, superávit energético, tres escenarios de desarrollo. 6 H2s, FAQ, 2.408 palabras, 13 fuentes. Observatorio completo 42/42. | 5-ago |
| 117 | Fact-check #42: 2 FALSE corregidos (PIB per cápita 5900→9400, solar duplica→+50%). 5 PARTIALLY TRUE corregidos (fibra 28% avance, Atacama→Sudamérica, 100%→99,9%, graduados calificados, Itaipú acuerdo tarifario). | 5-ago |
| 118 | Directorio actualizado post #42 (+sección Prospectiva y planificación). Observatorio completo con 8/8 páginas verificadas. | 5-ago |
| 119 | Simulador interactivo Paraguay 2040: página `/simulador-2040/`, include `simulador-2040.html`, 5 palancas + 2 shocks, canvas chart, scoped CSS. | 7-ago |
...
- Artículo #43 publicado: "El plan energético al 2050 que Paraguay escribió y todavía no ejecuta". Tesis: Paraguay no tiene un problema de energía, tiene un problema de institucionalidad. PEN 2050 (Decreto 2553/24, 95 obj/385 metas, meta MEHM 2024 incumplida), Mesa Energética (creación 2012, reactivación oct-2023, convocatoria 6-ago-2026), intentos de ministerio 2018/2020/2026, consumo 29,4 TWh (29.419 GWh 2025, demanda con pérdidas), 41 empresas 943,8 MW, 6.300 MW ≈ 90% de 7.000 MW de Itaipú, comparación MIEM/Chile/Brasil. 5 H2s, FAQ schema, ~2.450 palabras, 21 fuentes. 5 subagentes investigación (carpeta `research_mesa-energetica-pen-2050/`), fact-check independiente Compuerta B: 0 FALSE, 2 correcciones menores aplicadas (fecha UIP/Feprinco 7-ago, comillas Pombo).
...
- Fase Agotamiento del superávit: canon unificado — consumo nacional 2025 = 29.419 GWh (29,4 TWh, demanda del sistema con pérdidas según ANDE 14-01-2026); el dato "15-16 TWh" era ~2019-2020 y NO debe usarse como consumo actual. Excedente exportado ≈35% (~15 TWh).
- Pillar page: nota aclaratoria "¿2040 o 2050?" — 2040 es el horizonte de análisis editorial del observatorio (bono demográfico sin fecha oficial: INE ~2070, UIP 2030-2040; el artículo usa ~2045 como horizonte de análisis; fin del superávit ~2035-2040 como proyección del modelo); 2050 es el horizonte oficial del Estado (PEN, Decreto 2553/2024), no una meta elegida. Previene la ambigüedad de marca entre el artículo Paraguay 2040 + simulador y el artículo PEN 2050.
...
- Artículo #42 publicado: "Paraguay 2040: un país construido con datos". Prospectiva a 15 años: bono demográfico (ventana hasta 2045), superávit energético (se agota 2035-2040), data centers (de 944 MW a 2.000-8.000 MW proyectados), tres escenarios de desarrollo (hub regional, exportador barato, superávit desperdiciado). 6 H2s, FAQ, 2.408 palabras, 13 fuentes. **Observatorio completo: 42/42.**
- Fact-check #42 (3 rondas): 2 FALSE corregidos (PIB 5900→9400, solar duplica→+50%). 9 PARTIALLY TRUE corregidos (Itaipú reanudado nov 2025, fecundidad 1.7-1.8, fibra BID $130M, informalidad 60-64%, Atacama→Sudamérica, 100%→99.9%, graduados calificados, Itaipú acuerdo tarifario vs Anexo C).
- AGENTS.md ampliado: +3 secciones nuevas (Demografía y economía, Itaipú Anexo C, Fibra óptica). Total: 7 secciones de claims verificados, 30+ fuentes primarias paraguayas obligatorias.
- Estrategia sincronizada: §2.1 (42 artículos, 156 total), §3.2 (42/42 ✅), §15 (limpio), §17 (+3 items), §19 (changelog).
- Observatorio: 8/8 páginas verificadas con referencia al artículo #42. Directorio corregido (+Prospectiva).

### 4 de agosto 2026

- Artículo #8 publicado: "Qué le pasa a una ciudad paraguaya cuando llega un data center". HIVE en Yguazú/Valenzuela (USD 56M + $19M PPA, 300 MW, 60-150 empleos). Infraestructura privada sin spillover comunitario documentado. Lecciones globales: Loudoun County ($733M impuestos, 38% Fondo General, 42 grupos opositores), Irlanda (23% consumo 2025, moratoria CRU), Suecia (Luleå, calefacción distrital). Vacío regulatorio PY: sin cuotas locales, sin obligaciones comunitarias, Ley 294/1993 EIA nunca aplicada al sector. 5 H2s, FAQ, 2.457 palabras, 13 fuentes. Pilar 1 completado al 100%.
- Fact-check #8: 5 FALSE corregidos (cronología HIVE nov 2024→mid 2025, subestación 200MW en Valenzuela→Yguazú, Irlanda 2023→2025, rural→urbano, EirGrid→CRU). Segunda ronda: Bitfarms timeline (venta ene 2025, salida ene 2026), Loudoun números (45%→38%/33%, $600M→$733M JLARC 2024), HIVE sede San Antonio TX.
- AGENTS.md ampliado: sección "Data centers e impacto local" (9 claims verificados). Fuentes primarias paraguayas ahora obligatorias en fact-checking (§5.8 + §6.2 actualizados).
- Estrategia sincronizada: §3.2 (#8 ✅, 41/42), §15 (limpio), §17 (+4 items), §19 (changelog).
- Pilar 1 completado: los 8 temas de Infraestructura y energía publicados. Queda solo artículo #42 (Paraguay 2040, Pilar 5).

### 3 de agosto 2026

- Pulso Tech Paraguay: Pulso Diario Paraguay renombrado y reenfocado. Filtro temático exclusivo (IA, tech, infraestructura digital, energía, regulación, startups, ciencia). Secciones condicionales (solo categorías con noticias). Fuentes reducidas de 15 a 7 (eliminados deportes, espectáculos, mundo, Megacadena 403, RDN 404, ABC Economía 404). Fallback "Sin novedades" para días sin contenido tech.
- Bug crítico corregido: f-string escapaba `{{}}` y Gemini no recibía noticias reales — todos los Pulsos Tech iniciales eran alucinaciones.
- Modelo: gemini-3-flash-preview → gemini-3.1-flash-lite (3-flash-preview saturado con 503 persistente). Retry con backoff agregado a pulso_diario.py (3 intentos, 2s/4s/8s).
- Tono profesionalizado: system prompt actualizado para español paraguayo neutro/profesional, sin jerga coloquial ("che", "atende", "te toca el bolsillo"). Insight reformulado como análisis serio.
- Diseño: espacio en blanco antes de "📊 Relevancia" en todas las secciones. Títulos truncados corregidos (límite 80 chars + stopword stripping).
- Slugs renombrados: `pulso-paraguay` → `pulso-tech-paraguay` en pulso_diario.py, editorial_diario.py y fix_pulso_descriptions.py.
- /como-trabajamos/ actualizado: nuevas fuentes, modelo, metodología Pulso Tech, tono profesional.
- Estrategia SEO local actualizada: §1.1, §12.1, §12.2, §13.1, §17, §19.

### 1 de agosto 2026

- Artículo #15 publicado: "Lo que Itaipú le enseña a Paraguay sobre inteligencia artificial". Análisis de gobernanza binacional: estructura de Itaipú (Tratado 1973, 50/50, Consejo paritario), Yguazú Digital (MoU 2026, ICDF, modelo propuesto), lecciones de Yacyretá (sobrecosto 5-8x, 3 décadas), comparación con CERN (25 miembros, decisiones por mérito), asimetría Paraguay-Taiwán, vacío legal de gobernanza de datos (Embajada de Datos Digitales). 6 H2s, FAQ schema, 2.497 palabras, 13 fuentes. 2 enlaces internos (#1 Yguazú, #10 China-Taiwán).
- Migración GitHub Models → Gemini API: GitHub Models retirado 30-jul-2026. Scripts pulso_diario.py y editorial_diario.py migrados a Google Gemini API (gemini-3-flash-preview, v1beta, tier gratuito). Workflows actualizados (GEMINI_API_KEY). Diagnóstico agregado al CI. Modelos 2.0 (quota 0), 2.5 (deprecado) y 1.5 (inexistente) descartados tras 8 intentos de prueba.
- Timezone corregido: UTC-4 → UTC-3 en ambos scripts (Paraguay permanente desde 2024). Editorial frontmatter -0400 → -0300.
- Editorial truncada corregida: maxOutputTokens 2000 → 4000 para gemini-3-flash-preview.
- Hardening del sistema editorial:
  - validate_publish.py: 5 warnings de observatorio (glosario, cronologia, regulacion, directorio, casos-de-uso) convertidos a errores bloqueantes. Agregado check de entidades/.
  - jekyll.yml CI: nuevo paso "Validar ecosistema" que cancela el deploy si un artículo nuevo no incluye las 8 páginas del observatorio.
- Observatorio completo actualizado: cronologia (+1 hito Yguazú), regulacion (+sección Gobernanza binacional), directorio (+ICDF Taiwan), casos-de-uso (+Yguazú Digital como caso de gobernanza), glosario (+Entidad binacional, término #68), pillar page (+artículo #15, P2 al 100%), llms.txt (+1 link), entidades regeneradas.
- Estrategia sincronizada: §2.1 (40 artículos, 152 total), §3.2 (#15 ✅, 40/42 publicados, P2 100%), §15 (#15 removido de pendientes), §16 (#15 auditado).
- Fact-check #15: 0 FALSE, 7 PARTIALLY TRUE corregidos (Yacyretá costos, CERN miembros/presupuesto, ICDF→Taiwán, fecha deuda Itaipú). Aclaración brecha costo construcción vs deuda total Itaipú ($19.6B vs $63.5B).
